...
print("vadd: " + str(df_clk.query('platform=="U50-HBM" and application.str.startswith("vadd")')['number'].mean()))
print("vadd: " + str(df_clk.query('platform=="U280-HBM" and application.str.startswith("vadd")')['number'].mean()))
print("vadd: " + str(df_clk.query('platform=="U280-DDR" and application.str.startswith("vadd")')['number'].mean()))
print("stream_io: " + str(df_clk.query('platform=="U50-HBM" and application.str.startswith("stream_io")')['number'].mean()))
print("stream_io: " + str(df_clk.query('platform=="U280-HBM" and application.str.startswith("stream_io")')['number'].mean()))
print("stream_io: " + str(df_clk.query('platform=="U280-DDR" and application.str.startswith("stream_io")')['number'].mean()))
...
def simple_bars(df: pd.DataFrame, ylabel_name):
    ...
    g.ax.legend(prop={'size': 7}, loc='right', bbox_to_anchor=(1,0.9))
